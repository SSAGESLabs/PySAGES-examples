...
"""
SpectralABF simulation of a butane molecule in HOOMD-blue v. 3.x and PySAGES.
"""
...
def get_args(argv):
    available_args = [
        ("fit-freq", "f", int, 100, "Fitting frequency"),
...
def main(argv=[]):
    ...
    method = SpectralABF(cvs, grid,fit_freq=args.fit_freq)
